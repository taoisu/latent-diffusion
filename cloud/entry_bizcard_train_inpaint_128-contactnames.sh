...
export LOG_DIR="${AZUREML_DATAREFERENCE_ocrd}/Vertical/vdipainter/logs/business_card/contact_names"
export TOKENIZERS_PARALLELISM="false"

python3 main.py                                                                 \
    --scale_lr false                                                            \
    --base configs/just-diffusion/bizcard128_fsdp-fairscale-contactnames.yaml \
    --accelerator gpu                                                           \
