...
class BasicTransformerBlockLegacy(nn.Module):
    '''
    This block cannot handle deepspeed correctly, hence the name legacy
    '''
    ...
    def __init__(
        ...
        self.transformer_blocks = nn.ModuleList([
            BasicTransformerBlock(
                ...
                dropout=dropout,
                context_dim=context_dim,
                checkpoint=checkpoint) for d in range(depth)]
        )
