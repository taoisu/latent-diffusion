...
class DDPM(pl.LightningModule):
    ...
    @torch.no_grad()
    def p_sample_loop(self, shape:Tuple, return_intermediates:bool=False):
    ...
    @torch.no_grad()
    def sample(self, batch_size:int=16, return_intermediates:bool=False):
...
class LatentDiffusion(DDPM):
    ...
    def _get_denoise_row_from_list(self, samples:List, desc:str='', force_no_decoder_quantization:bool=False):
        denoise_row = []
    ...
    def p_mean_variance(
        ...
        t:Tensor,
        clip_denoised:bool,
        return_codebook_ids:bool=False,
